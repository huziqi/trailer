...
public class Movement : MonoBehaviour
{
    ...
    {
        // input from arrows
        Player1control_x = Input.GetAxis("Horizontal");
        Player1control_y = Input.GetAxis("Vertical");
        //input from AWSD
        Player2control_x = Input.GetAxis("Horizontal2");
        Player2control_y = Input.GetAxis("Vertical2");
